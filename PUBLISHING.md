...
```text
hearth-ui-vue-0.4.0.tgz
hearth-ui-elements-0.4.0.tgz
SHA256SUMS
```
...
```sh
npm publish ./release-dist/hearth-ui-vue-0.4.0.tgz --access public --tag latest
npm publish ./release-dist/hearth-ui-elements-0.4.0.tgz --access public --tag latest
```
